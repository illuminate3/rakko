	...
	@foreach ($links as $link)
		...
		<div class="dd-content">
			...
			<div class="ns-actions">
				<a title="Publish Menu" id="{{ $link->id }}" class="publish" href="#">
					<img id="publish-image-{{ $link->id }}" alt="Publish" src="/assets/images/not_publish_16x16.png">
				</a>
				<a title="Edit Menu" class="edit-menu" href="admin.menu.edit/{{ $link->id }}">
					<img alt="Edit" src="/assets/images/edit.png">
				</a>
				<a class="delete-menu" href="admin.menu.delete/{{ $link->id }}">
					<img alt="Delete" src="/assets/images/cross.png">
				</a>
				<input type="hidden" value="{{ $link->id }}" name="menu_id">
			</div>
		</div>
		</li>
	@endforeach
