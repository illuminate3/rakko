...
<h1>
	<p class="pull-right">
	<a href="/departments" class="btn btn-default" title="{{ trans('kotoba::button.back') }}">
...
<div class="row">
<div class="col-sm-4">
	<a href="/departments" class="btn btn-default btn-block" title="{{ trans('kotoba::button.cancel') }}">
