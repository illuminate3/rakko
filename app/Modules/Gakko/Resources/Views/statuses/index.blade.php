...
{{-- Web site Title --}}
@section('title')
{{ Lang::choice('kotoba::hr.status', 2) }} :: @parent
@stop
...
@section('inline-scripts')
	...
	$(document).ready(function() {
		oTable = $('#table').dataTable({
			...
			"bProcessing" : true,
			"bServerSide" : true,
			"sAjaxSource" : "{{ URL::to('api/statuses') }}",
		});
	});
@stop
...
<h1>
	<p class="pull-right">
	<a href="/statuses/create" class="btn btn-primary" title="{{ trans('kotoba::button.new') }}">
		<i class="fa fa-plus fa-fw"></i>
		{{ trans('kotoba::button.new') }}
	</a>
	</p>
	<i class="fa fa-angle-double-right fa-lg"></i>
		{{ Lang::choice('kotoba::hr.status', 2) }}
	<hr>
</h1>
</div>
