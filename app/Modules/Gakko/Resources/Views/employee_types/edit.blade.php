...
<h1>
	<p class="pull-right">
	<a href="/employee_types" class="btn btn-default" title="{{ trans('kotoba::button.back') }}">
...
{!! Form::model(
	$employee_type,
	[
		'route' => ['employee_types.update', $employee_type->id],
		'method' => 'PATCH',
		'class' => 'form'
	]
) !!}
...
<div class="row">
<div class="col-sm-4">
	<a href="/employee_types" class="btn btn-default btn-block" title="{{ trans('kotoba::button.cancel') }}">
