...
{{-- Web room Title --}}
@section('title')
{{ Lang::choice('kotoba::hr.room', 2) }} :: @parent
@stop
...
<h1>
	<p class="pull-right">
	<a href="/rooms" class="btn btn-default" title="{{ trans('kotoba::button.back') }}">
...
<div class="input-group">
	<span class="input-group-addon"><i class="fa fa-gavel fa-fw"></i></span>
		<input type="text" id="name" name="name" value="{{ $room->name }}" placeholder="{{ trans('kotoba::account.name') }}" class="form-control" autofocus="autofocus">
</div>
</div>
...
<div class="input-group">
	<span class="input-group-addon"><i class="fa fa-briefcase fa-fw"></i></span>
		<input type="text" id="description" name="description" value="{{ $room->description }}" placeholder="{{ trans('kotoba::general.description') }}" class="form-control">
</div>
</div>
...
<div class="row">
<div class="col-sm-4">
	<a href="/rooms" class="btn btn-default btn-block" title="{{ trans('kotoba::button.cancel') }}">
