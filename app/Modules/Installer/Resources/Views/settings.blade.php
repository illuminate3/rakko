		...
		<div class="panel panel-default">
			...
			<div class="panel-body body_panel">
				...
				<div class="form-group">
					<label for="inputTimeZone" class="col-sm-3 control-label">{{ trans('installer::install.time_zone') }}</label>
					<div class="col-sm-9">
						<select  id="timezone" name="timezone" class="field_input installtz">
				...
				<div class="row">
					<div class="col-sm-8 col-sm-offset-2" id="button">
						<input type="submit" class="btn btn-success btn-block" value="{{ trans('installer::install.button.submit') }}"/>
					</div>
				</div>
