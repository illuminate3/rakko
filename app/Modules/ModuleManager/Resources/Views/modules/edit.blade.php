...
<h1>
	<p class="pull-right">
	<a href="/module_manager" class="btn btn-default" title="{{ trans('kotoba::button.back') }}">
...
{!! Form::model(
	$module,
	[
		'route' => ['module_manager.update', $module->id],
		'method' => 'PATCH',
		'class' => 'form'
	]
) !!}
...
<div class="row">
<div class="col-sm-4">
	<a href="/module_manager" class="btn btn-default btn-block" title="{{ trans('kotoba::button.cancel') }}">
